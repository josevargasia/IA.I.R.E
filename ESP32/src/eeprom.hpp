...
#define EEPROM_SIZE     70             /**< EEPROM size address. */
...
#define MAX_PRESSURE_ADJUST     MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_KP_INSP         MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_TI_INSP         MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_TD_INSP         MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_KP_EXP          MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_TI_EXP          MAX_32_BITS     /**< Length in bytes of numeric values. */
#define MAX_PID_TD_EXP          MAX_32_BITS     /**< Length in bytes of numeric values. */
...
#define ADDR_PRESSURE_ADJUST    INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT /**< Address of variable. */
#define ADDR_PID_KP_INSP        INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST /**< Address of variable. */
#define ADDR_PID_TI_INSP        INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST+MAX_PID_KP_INSP /**< Address of variable. */
#define ADDR_PID_TD_INSP        INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST+MAX_PID_KP_INSP+MAX_PID_TI_INSP /**< Address of variable. */
#define ADDR_PID_KP_EXP         INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST+MAX_PID_KP_INSP+MAX_PID_TI_INSP+MAX_PID_TD_INSP /**< Address of variable. */
#define ADDR_PID_TI_EXP         INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST+MAX_PID_KP_INSP+MAX_PID_TI_INSP+MAX_PID_TD_INSP+MAX_PID_KP_EXP /**< Address of variable. */
#define ADDR_PID_TD_EXP         INIT_PAGE_0+MAX_PRESSURE_MAX+MAX_INSPIRATION_TIME+MAX_EXPIRATION_TIME+MAX_PWM5_DUTY+MAX_PWM5_FREC+MAX_PRESSURE_INS+MAX_PRESSURE_EXP+MAX_RESPIRA_MODES+MAX_SENSITIVITY+MAX_ALARM_HIGH+MAX_ALARM_LOW+MAX_C02_ZP_VOLT+MAX_PRESSURE_ADJUST+MAX_PID_KP_INSP+MAX_PID_TI_INSP+MAX_PID_TD_INSP+MAX_PID_KP_EXP+MAX_PID_TI_EXP /**< Address of variable. */
